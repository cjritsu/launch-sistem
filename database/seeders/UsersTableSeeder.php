...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $user = new User(['name'=>'Admin Admin','nip'=>'admin','password'=>'bknadminlu','roles_id'=>'1','created_at'=>now()]);$user->assignRole('Admin');$user->save();
        ...
        $user = new User(['name'=>'Johan Santoso','nip'=>'220015','password'=>'220015','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Joese Nathaniel','nip'=>'220017','password'=>'220017','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Robert Ananda Aritonang','nip'=>'220019','password'=>'220019','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Tracya Dewi, A.','nip'=>'150075','password'=>'150075','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Amesanggeg Pataropura','nip'=>'150050','password'=>'150050','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
        $user = new User(['name'=>'Suwitno','nip'=>'150058','password'=>'150058','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Sevtian Ferdian','nip'=>'190003','password'=>'190003','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Rio Permana','nip'=>'150054','password'=>'150054','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
        $user = new User(['name'=>'Daniel Yesaya','nip'=>'200008','password'=>'200008','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Alvin Rahayu','nip'=>'220007','password'=>'220007','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Sugiyanto','nip'=>'150083','password'=>'150083','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Sudady Lawita','nip'=>'190006','password'=>'190006','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
        ...
        $user = new User(['name'=>'Suryadi Wadiana','nip'=>'220018','password'=>'220018','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Yakub','nip'=>'150187','password'=>'150187','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Fajar Gumilang','nip'=>'220014','password'=>'220014','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Pahtuh','nip'=>'230002','password'=>'230002','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Cecilia Tirta Wijaya','nip'=>'220016','password'=>'220016','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Limajati','nip'=>'150190','password'=>'150190','roles_id'=>'4','created_at'=>now()]);$user->assignRole('Rektorat');$user->save();
        $user = new User(['name'=>'Unif Riyanto','nip'=>'180011','password'=>'180011','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Jeni Hariyanto','nip'=>'230001','password'=>'230001','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'Handayani','nip'=>'220020','password'=>'220020','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
        ...
        $user = new User(['name'=>'Riswanto','nip'=>'150168','password'=>'150168','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
        ...
        $user = new User(['name'=>'Tjian Liam','nip'=>'150090','password'=>'150090','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
        ...
        $user = new User(['name'=>'Pohan Simanjuntak (Hormon)','nip'=>'150159','password'=>'150159','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        ...
        $user = new User(['name'=>'G. Widiyanto','nip'=>'150020','password'=>'150020','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Chatrine Gouwtama','nip'=>'150068','password'=>'150068','roles_id'=>'2','created_at'=>now()]);$user->assignRole('Staff');$user->save();
        $user = new User(['name'=>'Deki Sulistiyo','nip'=>'150112','password'=>'150112','roles_id'=>'3','created_at'=>now()]);$user->assignRole('Kepala Unit');$user->save();
    }
}

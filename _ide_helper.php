...
')
     ...
     */ 
         ...
         * 
         *
         * @see \LaravelFrontendPresets\PaperPreset\PaperPresetServiceProvider::boot()
         * @param mixed $command
         * @static 
         */ 
        public static function paper($command)
        {
                        return \Illuminate\Console\Command::paper($command);
        }
